...
dictionary.filter_extremes(no_below=150, no_above=0.1, keep_n=1000000)
...
'''
lda_model = gensim.models.LdaModel(corpus=bow_corpus, id2word=dictionary, num_topics=20)
...
for count, unseen_document in enumerate(newsgroups_test.data):
    ...
    for index, score in sorted(lda_model[bow_vector], key=lambda tup: -1*tup[1]):
        ...
        print(newsgroups_test.target[count])
